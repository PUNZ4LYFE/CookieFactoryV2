var VanillaBiscuit = (
	function () {
        ...
        //Inheritance
		VanillaBiscuit.prototype = Object.create(Cookie.prototype);
		VanillaBiscuit.prototype.constructor = Cookie;

		VanillaBiscuit.prototype.SetPositioAndStyle = function () {
