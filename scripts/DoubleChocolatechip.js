var DoubleChocolatechip = (
	function () {
		function DoubleChocolatechip() {
			this.type = 0;
            this.div;
        ...
        //Inheritance
		DoubleChocolatechip.prototype = Object.create(Cookie.prototype);
		DoubleChocolatechip.prototype.constructor = Cookie;
