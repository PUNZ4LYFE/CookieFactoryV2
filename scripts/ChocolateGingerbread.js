var ChocolateGingerbread = (
	function () {
		function ChocolateGingerbread() {
			this.type = 0;
            this.div;
        ...
        //Inheritance
		ChocolateGingerbread.prototype = Object.create(Cookie.prototype);
		ChocolateGingerbread.prototype.constructor = Cookie;

		ChocolateGingerbread.prototype.SetPositioAndStyle = function () {
