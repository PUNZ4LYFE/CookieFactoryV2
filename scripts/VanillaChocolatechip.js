var VanillaChocolatechip = (
	function () {
		function VanillaChocolatechip() {
			this.type = 0;
            this.div;
        ...
        //Inheritance
		VanillaChocolatechip.prototype = Object.create(Cookie.prototype);
		VanillaChocolatechip.prototype.constructor = Cookie;

		VanillaChocolatechip.prototype.SetPositioAndStyle = function () {
