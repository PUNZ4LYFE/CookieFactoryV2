var MarbleChocolatechip = (
	function () {
		function MarbleChocolatechip() {
			this.type = 0;
            this.div;
        ...
        //Inheritance
		MarbleChocolatechip.prototype = Object.create(Cookie.prototype);
		MarbleChocolatechip.prototype.constructor = Cookie;
